...
- [ ] tab topo
    ...
    * [x] проверка что карты уже загружены?
...
- [ ] tab block
    ...
    * [x] draw in child layer


- [ ] отрисовка геообъектов
    * [x] функция возвращения геообъекта - набора координат точек
    * [x] архитектура представления геообъектов - по категориям
    * [x] класс родитель со свойствами раскраски для полилиний и полигонов
    * [ ] раскраска полилиний
    * [x] раскраска полигонов
