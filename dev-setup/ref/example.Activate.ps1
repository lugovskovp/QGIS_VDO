...
$env:CURL_CA_BUNDLE="c:\OSGeo4W\bin\curl-ca-bundle.crt"

$env:GDAL_DATA="c:\OSGeo4W\apps\gdal\share\gdal"
$env:GDAL_DRIVER_PATH="c:\OSGeo4W\apps\gdal\lib\gdalplugins"
$env:GDAL_FILENAME_IS_UTF8="YES"
$env:GS_LIB="c:\OSGeo4W\apps\gs\lib"

$env:O4W_QT_BINARIES="c:/OSGeo4W/apps/Qt5/bin"
$env:O4W_QT_DOC="c:/OSGeo4W/apps/Qt5/doc"
$env:O4W_QT_HEADERS="c:/OSGeo4W/apps/Qt5/include"
$env:O4W_QT_LIBRARIES="c:/OSGeo4W/apps/Qt5/lib"
$env:O4W_QT_PLUGINS="c:/OSGeo4W/apps/Qt5/plugins"
$env:O4W_QT_PREFIX="c:/OSGeo4W/apps/Qt5"
$env:O4W_QT_TRANSLATIONS="c:/OSGeo4W/apps/Qt5/translations"

$env:OPENSSL_ENGINES="c:\OSGeo4W\lib\engines-3"

$env:OSGEO4W_ROOT="c:\OSGeo4W"

$env:PDAL_DRIVER_PATH="c:\OSGeo4W\apps\pdal\plugins"
...
$env:SSL_CERT_DIR="c:\OSGeo4W\apps\openssl\certs"
$env:SSL_CERT_FILE="c:\OSGeo4W\bin\curl-ca-bundle.crt"
